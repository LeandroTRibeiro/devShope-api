...
router.post('/user/add/wish', WishListController.addAndRemoveWish);
router.post('/user/show/wishlist', WishListController.getWishs);
router.post('/user/show/wishproducts', WishListController.getWishListProducts);

router.post('/cart/add', CartListController.addToCart);
router.post('/cart/get', CartListController.getCart);
